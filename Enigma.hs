...
{- Part 1: Simulation of the Enigma -}
  type Rotor = String -- the supplied type is not correct; fix it!
  ...
  encodeMessage String SimpleEnigma(Rotor Rotor Rotor Reflector Offsets)
  =
  encodeMessage String SteckeredEnigma(Rotor Rotor Rotor Reflector Offsets Stecker)
  =
